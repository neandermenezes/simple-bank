...
func TestTransferAPI(t *testing.T) {
	...
	account1.Currency = api_utils.USD
	account2.Currency = api_utils.USD
	account3.Currency = api_utils.EUR
	...
	testCases := []struct {
		...
		// 			Amount:        amount,
		// 		}
		// 		store.EXPECT().TranferTx(gomock.Any(), gomock.Eq(arg)).Times(1)
		// 	},
